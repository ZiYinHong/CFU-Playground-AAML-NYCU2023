...
def gen_one_case(i, in_fd=None, c_fd=None, all_one=False, mode=0, shape_range=(4, 256), val_range=(0, 255)): #255
    ...
    if mode == 0:
        ...
        K = 255#random.randint(shape_range[0], shape_range[1])
        M = 4#random.randint(shape_range[0], shape_range[1])
        N = 4#random.randint(shape_range[0], shape_range[1])
...
def main():
    ...
    for n in range(ncases):
        gen_one_case(n, in_fd, legible_fd, all_one=all_one, mode=mode, shape_range=(4, 256), val_range=(0, 255))
